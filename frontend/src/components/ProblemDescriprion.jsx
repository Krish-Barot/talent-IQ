...
export default function ProblemDescriprion({ problem, currentProblemId, onProblemChange, allProblems }) {
  return (
    <div className="h-full overflow-y-auto bg-base-200">
      ...
      <div className="p-6 bg-base-100 border-b border-base-300">
        <div className="flex item-start justify-between mb-3">
          ...
          <span className={`badge ${getdifficultyBadgeClass(problem.difficulty)}`}></span>
        </div>
        ...
        <div className="mt-4">
          <select className="select select-sm w-full" value={currentProblemId} onChange={(e) => onProblemChange(e.target.value)}>{allProblems.map((p) => (
